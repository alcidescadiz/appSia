...
@section('content')
<div class="container"><h2>Productos compuestos</h2></div>
...
<div class="container" style="background-color: #F7DBF0; border-radius: 20px; padding: 20px">
    ...
    <form action="{{URL::to('/crearcompuesto')}}" method="POST" style="margin:5px; padding: 5px; width: 95% ">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="codigo" readonly value="COMP{{$idnew}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" class="form-control" name="costoc" id="costoc" readonly value="{{$ttotal}}" onchange="precio_venta_compuesto() ">
        </div>
        <div class="form-group">
            <label for="">Porcentaje de Ganancia</label>
            <input type="number"  step="0.01" class="form-control" name="porcentage_ganancia" id="porcentage_ganancia" onchange="precio_venta_compuesto() ">
        </div>
        <div class="form-group">
            <label for="">Precio de Venta</label>
            <input type="number" step="0.01" class="form-control" name="precio_venta" id="precio_venta"  readonly onchange="precio_venta_compuesto() ">
        </div>
        <div class="form-group">
    ...
    <div class="col-sm-5 col-md-8">
        ...
        <form action="{{URL::to('/detallescompuestos')}}" method="post" style="margin:5px; padding: 5px; width: 95% ">
            {!! csrf_field() !!} 
    ...
    <hr>
    <x-detalles_compuesto :detalles='$detalles' :idnew='$idnew'/>
